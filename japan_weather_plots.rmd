...
# change to a better CRS?
st_crs(sf_pref13, 
             crs = "+proj=eqdc +lat_0=0 +lon_0=138 +lat_1=34 +lat_2=40 +x_0=0 +y_0=0 +ellps=WGS84 +units=m +no_defs") -> sf_pref13
...
sf_pref13 %>% 
  ...
  coord_sf(xlim = c(138.85, 140), ylim = c(35.5, 36), expand = c(0, 0)) +
  theme_minimal() +

...
With Autumn now settling in and the chances of rain increasing, I'll end this blog post with a picture of a _teru-teru-bouzu_. These are handmade dolls made of white paper/cloth (usually tissue paper) which are basically talismans to prevent rain and to wish for good weather in Japan. 
